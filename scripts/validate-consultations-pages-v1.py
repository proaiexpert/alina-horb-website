...
for relative, expected in PAGES.items():
    ...
    require('priceCurrency": "EUR"' in text and '"price": "20"' in text, f"{relative}: price schema mismatch")
    ...
    require('50' in text and '20 €' in text and '1 000 грн' in text and '770 грн' in text and '7 700 грн' in text, f"{relative}: confirmed duration/price missing")
