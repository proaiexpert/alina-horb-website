...
for relative, expected in PAGES.items():
    ...
    require('data-contact-form' in text and 'data-form-status' in text, f"{relative}: contact form missing")
    require(('name="format"' in text or 'name="service"' in text) and 'name="message"' in text, f"{relative}: consultation intake fields missing")
...
print("Consultations pages validation passed for UA and RU routes")
